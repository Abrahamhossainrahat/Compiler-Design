...
bool isArithmatic(string token){
    for(auto &op : arithmaics){
        if(op == token) return true;
    }
    return false;
}
...
int main(){
    ...
    while(getline(cin,word)){
        ...
        else if(isArithmatic(word)){
            cout << word << " : Arithmetic Operator" << endl;
        }
